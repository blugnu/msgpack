...
func TestEncoder(t *testing.T) {
	...
	testcases := []struct {
		...
		// begin array
		{spec: "BeginArray(0)", fn: func() error { return enc.BeginArray(0) }, expect: expect{result: []byte{0x90}}},
		{spec: "BeginArray(1)", fn: func() error { return enc.BeginArray(1) }, expect: expect{result: []byte{0x91}}},
		{spec: "BeginArray(15)", fn: func() error { return enc.BeginArray(15) }, expect: expect{result: []byte{0x9f}}},
		{spec: "BeginArray(16)", fn: func() error { return enc.BeginArray(16) }, expect: expect{result: []byte{0xdc, 0x00, 0x10}}},
		{spec: "BeginArray(65535)", fn: func() error { return enc.BeginArray(65535) }, expect: expect{result: []byte{0xdc, 0xff, 0xff}}},
		{spec: "BeginArray(65536)", fn: func() error { return enc.BeginArray(65536) }, expect: expect{result: []byte{0xdd, 0x00, 0x01, 0x00, 0x00}}},
		{spec: "BeginArray(4294967295)", fn: func() error { return enc.BeginArray(4294967295) }, expect: expect{result: []byte{0xdd, 0xff, 0xff, 0xff, 0xff}}},
		{spec: "BeginArray(0) (error)", errorState: true, fn: func() error { return enc.BeginArray(0) }, expect: expect{error: encerr}},
		{spec: "BeginArray(1) (error)", errorState: true, fn: func() error { return enc.BeginArray(1) }, expect: expect{error: encerr}},
		{spec: "BeginArray(15) (error)", errorState: true, fn: func() error { return enc.BeginArray(15) }, expect: expect{error: encerr}},
		{spec: "BeginArray(16) (error)", errorState: true, fn: func() error { return enc.BeginArray(16) }, expect: expect{error: encerr}},
		{spec: "BeginArray(65535) (error)", errorState: true, fn: func() error { return enc.BeginArray(65535) }, expect: expect{error: encerr}},
		{spec: "BeginArray(65536) (error)", errorState: true, fn: func() error { return enc.BeginArray(65536) }, expect: expect{error: encerr}},
		{spec: "BeginArray(4294967295) (error)", errorState: true, fn: func() error { return enc.BeginArray(4294967295) }, expect: expect{error: encerr}},
		// begin map
		{spec: "BeginMap(0)", fn: func() error { return enc.BeginMap(0) }, expect: expect{result: []byte{0x80}}},
		{spec: "BeginMap(1)", fn: func() error { return enc.BeginMap(1) }, expect: expect{result: []byte{0x81}}},
		{spec: "BeginMap(15)", fn: func() error { return enc.BeginMap(15) }, expect: expect{result: []byte{0x8f}}},
		{spec: "BeginMap(16)", fn: func() error { return enc.BeginMap(16) }, expect: expect{result: []byte{0xde, 0x00, 0x10}}},
		{spec: "BeginMap(65535)", fn: func() error { return enc.BeginMap(65535) }, expect: expect{result: []byte{0xde, 0xff, 0xff}}},
		{spec: "BeginMap(65536)", fn: func() error { return enc.BeginMap(65536) }, expect: expect{result: []byte{0xdf, 0x00, 0x01, 0x00, 0x00}}},
		{spec: "BeginMap(4294967295)", fn: func() error { return enc.BeginMap(4294967295) }, expect: expect{result: []byte{0xdf, 0xff, 0xff, 0xff, 0xff}}},
		{spec: "BeginMap(0) (error)", errorState: true, fn: func() error { return enc.BeginMap(0) }, expect: expect{error: encerr}},
		{spec: "BeginMap(1) (error)", errorState: true, fn: func() error { return enc.BeginMap(1) }, expect: expect{error: encerr}},
		{spec: "BeginMap(15) (error)", errorState: true, fn: func() error { return enc.BeginMap(15) }, expect: expect{error: encerr}},
		{spec: "BeginMap(16) (error)", errorState: true, fn: func() error { return enc.BeginMap(16) }, expect: expect{error: encerr}},
		{spec: "BeginMap(65535) (error)", errorState: true, fn: func() error { return enc.BeginMap(65535) }, expect: expect{error: encerr}},
		{spec: "BeginMap(65536) (error)", errorState: true, fn: func() error { return enc.BeginMap(65536) }, expect: expect{error: encerr}},
		{spec: "BeginMap(4294967295) (error)", errorState: true, fn: func() error { return enc.BeginMap(4294967295) }, expect: expect{error: encerr}},
		// begin string
		{spec: "BeginString(0)", fn: func() error { return enc.BeginString(0) }, expect: expect{result: []byte{0b10100000}}},
		{spec: "BeginString(1)", fn: func() error { return enc.BeginString(1) }, expect: expect{result: []byte{0b10100001}}},
		{spec: "BeginString(31)", fn: func() error { return enc.BeginString(31) }, expect: expect{result: []byte{0b10111111}}},
		{spec: "BeginString(32)", fn: func() error { return enc.BeginString(32) }, expect: expect{result: []byte{0xd9, 0b00100000}}},
		{spec: "BeginString(255)", fn: func() error { return enc.BeginString(255) }, expect: expect{result: []byte{0xd9, 0b11111111}}},
		{spec: "BeginString(256)", fn: func() error { return enc.BeginString(256) }, expect: expect{result: []byte{0xda, 0b00000001, 0b00000000}}},
		{spec: "BeginString(65535)", fn: func() error { return enc.BeginString(65535) }, expect: expect{result: []byte{0xda, 0b11111111, 0b11111111}}},
		{spec: "BeginString(65536)", fn: func() error { return enc.BeginString(65536) }, expect: expect{result: []byte{0xdb, 0b00000000, 0b00000001, 0b00000000, 0b00000000}}},
		{spec: "BeginString(16777216)", fn: func() error { return enc.BeginString(16777216) }, expect: expect{result: []byte{0xdb, 0b00000001, 0b00000000, 0b00000000, 0b00000000}}},
		{spec: "BeginString(4294967295)", fn: func() error { return enc.BeginString(4294967295) }, expect: expect{result: []byte{0xdb, 0b11111111, 0b11111111, 0b11111111, 0b11111111}}},
		{spec: "BeginString(0) (error)", errorState: true, fn: func() error { return enc.BeginString(0) }, expect: expect{error: encerr}},
		{spec: "BeginString(1) (error)", errorState: true, fn: func() error { return enc.BeginString(1) }, expect: expect{error: encerr}},
		{spec: "BeginString(31) (error)", errorState: true, fn: func() error { return enc.BeginString(31) }, expect: expect{error: encerr}},
		{spec: "BeginString(32) (error)", errorState: true, fn: func() error { return enc.BeginString(32) }, expect: expect{error: encerr}},
		{spec: "BeginString(255) (error)", errorState: true, fn: func() error { return enc.BeginString(255) }, expect: expect{error: encerr}},
		{spec: "BeginString(256) (error)", errorState: true, fn: func() error { return enc.BeginString(256) }, expect: expect{error: encerr}},
		{spec: "BeginString(65535) (error)", errorState: true, fn: func() error { return enc.BeginString(65535) }, expect: expect{error: encerr}},
		{spec: "BeginString(65536) (error)", errorState: true, fn: func() error { return enc.BeginString(65536) }, expect: expect{error: encerr}},
		{spec: "BeginString(16777216) (error)", errorState: true, fn: func() error { return enc.BeginString(16777216) }, expect: expect{error: encerr}},
		{spec: "BeginString(4294967295) (error)", errorState: true, fn: func() error { return enc.BeginString(4294967295) }, expect: expect{error: encerr}},
