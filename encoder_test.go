...
func TestEncoder(t *testing.T) {
	...
	testcases := []struct {
		...
		{spec: "Encode(int64(9223372036854775807))", fn: func() error { return enc.Encode(int64(9223372036854775807)) }, expect: expect{result: []byte{typeInt64, 0x7f, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff}}},
		...
		{spec: "EncodeInt64(4294967296)", fn: func() error { return enc.EncodeInt64(4294967296) }, expect: expect{result: []byte{typeInt64, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00}}},
		{spec: "EncodeInt64(9223372036854775807)", fn: func() error { return enc.EncodeInt64(9223372036854775807) }, expect: expect{result: []byte{typeInt64, 0x7f, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff}}},
		...
		{spec: "EncodeInt(4294967295)", fn: func() error { return enc.EncodeInt64(4294967295) }, expect: expect{result: []byte{typeUint32, 0xff, 0xff, 0xff, 0xff}}},
		{spec: "EncodeInt(4294967296)", fn: func() error { return enc.EncodeInt64(4294967296) }, expect: expect{result: []byte{typeInt64, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00}}},
		{spec: "EncodeInt(9223372036854775807)", fn: func() error { return enc.EncodeInt(9223372036854775807) }, expect: expect{result: []byte{typeInt64, 0x7f, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff}}},
		...
		// begin array
		{spec: "BeginArray(0)", fn: func() error { return enc.WriteArrayHeader(0) }, expect: expect{result: []byte{0x90}}},
		{spec: "BeginArray(1)", fn: func() error { return enc.WriteArrayHeader(1) }, expect: expect{result: []byte{0x91}}},
		{spec: "BeginArray(15)", fn: func() error { return enc.WriteArrayHeader(15) }, expect: expect{result: []byte{0x9f}}},
		{spec: "BeginArray(16)", fn: func() error { return enc.WriteArrayHeader(16) }, expect: expect{result: []byte{0xdc, 0x00, 0x10}}},
		{spec: "BeginArray(65535)", fn: func() error { return enc.WriteArrayHeader(65535) }, expect: expect{result: []byte{0xdc, 0xff, 0xff}}},
		{spec: "BeginArray(65536)", fn: func() error { return enc.WriteArrayHeader(65536) }, expect: expect{result: []byte{0xdd, 0x00, 0x01, 0x00, 0x00}}},
		{spec: "BeginArray(4294967295)", fn: func() error { return enc.WriteArrayHeader(4294967295) }, expect: expect{result: []byte{0xdd, 0xff, 0xff, 0xff, 0xff}}},
		{spec: "BeginArray(0) (error)", errorState: true, fn: func() error { return enc.WriteArrayHeader(0) }, expect: expect{error: encerr}},
		{spec: "BeginArray(1) (error)", errorState: true, fn: func() error { return enc.WriteArrayHeader(1) }, expect: expect{error: encerr}},
		{spec: "BeginArray(15) (error)", errorState: true, fn: func() error { return enc.WriteArrayHeader(15) }, expect: expect{error: encerr}},
		{spec: "BeginArray(16) (error)", errorState: true, fn: func() error { return enc.WriteArrayHeader(16) }, expect: expect{error: encerr}},
		{spec: "BeginArray(65535) (error)", errorState: true, fn: func() error { return enc.WriteArrayHeader(65535) }, expect: expect{error: encerr}},
		{spec: "BeginArray(65536) (error)", errorState: true, fn: func() error { return enc.WriteArrayHeader(65536) }, expect: expect{error: encerr}},
		{spec: "BeginArray(4294967295) (error)", errorState: true, fn: func() error { return enc.WriteArrayHeader(4294967295) }, expect: expect{error: encerr}},
		// begin map
		{spec: "BeginMap(0)", fn: func() error { return enc.WriteMapHeader(0) }, expect: expect{result: []byte{0x80}}},
		{spec: "BeginMap(1)", fn: func() error { return enc.WriteMapHeader(1) }, expect: expect{result: []byte{0x81}}},
		{spec: "BeginMap(15)", fn: func() error { return enc.WriteMapHeader(15) }, expect: expect{result: []byte{0x8f}}},
		{spec: "BeginMap(16)", fn: func() error { return enc.WriteMapHeader(16) }, expect: expect{result: []byte{0xde, 0x00, 0x10}}},
		{spec: "BeginMap(65535)", fn: func() error { return enc.WriteMapHeader(65535) }, expect: expect{result: []byte{0xde, 0xff, 0xff}}},
		{spec: "BeginMap(65536)", fn: func() error { return enc.WriteMapHeader(65536) }, expect: expect{result: []byte{0xdf, 0x00, 0x01, 0x00, 0x00}}},
		{spec: "BeginMap(4294967295)", fn: func() error { return enc.WriteMapHeader(4294967295) }, expect: expect{result: []byte{0xdf, 0xff, 0xff, 0xff, 0xff}}},
		{spec: "BeginMap(0) (error)", errorState: true, fn: func() error { return enc.WriteMapHeader(0) }, expect: expect{error: encerr}},
		{spec: "BeginMap(1) (error)", errorState: true, fn: func() error { return enc.WriteMapHeader(1) }, expect: expect{error: encerr}},
		{spec: "BeginMap(15) (error)", errorState: true, fn: func() error { return enc.WriteMapHeader(15) }, expect: expect{error: encerr}},
		{spec: "BeginMap(16) (error)", errorState: true, fn: func() error { return enc.WriteMapHeader(16) }, expect: expect{error: encerr}},
		{spec: "BeginMap(65535) (error)", errorState: true, fn: func() error { return enc.WriteMapHeader(65535) }, expect: expect{error: encerr}},
		{spec: "BeginMap(65536) (error)", errorState: true, fn: func() error { return enc.WriteMapHeader(65536) }, expect: expect{error: encerr}},
		{spec: "BeginMap(4294967295) (error)", errorState: true, fn: func() error { return enc.WriteMapHeader(4294967295) }, expect: expect{error: encerr}},
		// begin string
		{spec: "BeginString(0)", fn: func() error { return enc.WriteStringHeader(0) }, expect: expect{result: []byte{0b10100000}}},
		{spec: "BeginString(1)", fn: func() error { return enc.WriteStringHeader(1) }, expect: expect{result: []byte{0b10100001}}},
		{spec: "BeginString(31)", fn: func() error { return enc.WriteStringHeader(31) }, expect: expect{result: []byte{0b10111111}}},
		{spec: "BeginString(32)", fn: func() error { return enc.WriteStringHeader(32) }, expect: expect{result: []byte{0xd9, 0b00100000}}},
		{spec: "BeginString(255)", fn: func() error { return enc.WriteStringHeader(255) }, expect: expect{result: []byte{0xd9, 0b11111111}}},
		{spec: "BeginString(256)", fn: func() error { return enc.WriteStringHeader(256) }, expect: expect{result: []byte{0xda, 0b00000001, 0b00000000}}},
		{spec: "BeginString(65535)", fn: func() error { return enc.WriteStringHeader(65535) }, expect: expect{result: []byte{0xda, 0b11111111, 0b11111111}}},
		{spec: "BeginString(65536)", fn: func() error { return enc.WriteStringHeader(65536) }, expect: expect{result: []byte{0xdb, 0b00000000, 0b00000001, 0b00000000, 0b00000000}}},
		{spec: "BeginString(16777216)", fn: func() error { return enc.WriteStringHeader(16777216) }, expect: expect{result: []byte{0xdb, 0b00000001, 0b00000000, 0b00000000, 0b00000000}}},
		{spec: "BeginString(4294967295)", fn: func() error { return enc.WriteStringHeader(4294967295) }, expect: expect{result: []byte{0xdb, 0b11111111, 0b11111111, 0b11111111, 0b11111111}}},
		{spec: "BeginString(0) (error)", errorState: true, fn: func() error { return enc.WriteStringHeader(0) }, expect: expect{error: encerr}},
		{spec: "BeginString(1) (error)", errorState: true, fn: func() error { return enc.WriteStringHeader(1) }, expect: expect{error: encerr}},
		{spec: "BeginString(31) (error)", errorState: true, fn: func() error { return enc.WriteStringHeader(31) }, expect: expect{error: encerr}},
		{spec: "BeginString(32) (error)", errorState: true, fn: func() error { return enc.WriteStringHeader(32) }, expect: expect{error: encerr}},
		{spec: "BeginString(255) (error)", errorState: true, fn: func() error { return enc.WriteStringHeader(255) }, expect: expect{error: encerr}},
		{spec: "BeginString(256) (error)", errorState: true, fn: func() error { return enc.WriteStringHeader(256) }, expect: expect{error: encerr}},
		{spec: "BeginString(65535) (error)", errorState: true, fn: func() error { return enc.WriteStringHeader(65535) }, expect: expect{error: encerr}},
		{spec: "BeginString(65536) (error)", errorState: true, fn: func() error { return enc.WriteStringHeader(65536) }, expect: expect{error: encerr}},
		{spec: "BeginString(16777216) (error)", errorState: true, fn: func() error { return enc.WriteStringHeader(16777216) }, expect: expect{error: encerr}},
		{spec: "BeginString(4294967295) (error)", errorState: true, fn: func() error { return enc.WriteStringHeader(4294967295) }, expect: expect{error: encerr}},
